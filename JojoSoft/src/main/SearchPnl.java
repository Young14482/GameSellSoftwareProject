...
public class SearchPnl extends JPanel {
	...
	public SearchPnl(String searchStr, PnlBasic pnlBasic, String AnotherSearchStr) {
		reconstruction(searchStr, pnlBasic, AnotherSearchStr);
	}

	public void reconstruction(String searchStr, PnlBasic pnlBasic, String AnotherSearchStr) {
		saveStr = searchStr;
